...
use app\api\common\library\wechat\WxUser;
use app\api\common\exception\BaseException;
use think\Cache;
use think\Request;
...
class User extends UserModel
{
    ...
    private function wxlogin($code)
    {
        ...
        //$wxapp = Wxapp::detail();
        // 微信登录 (获取session_key)
        $wxapp = ['app_id'=>'wx86d37317af4038c8','app_secret'=>'a9cdb6717cffbd0f26873c114a0e3d33'];
